...
class ProfileCard extends Component {
    ...
    fetchUser = () => {
        ...
        fetch('https://sunset-space-server.herokuapp.com/api/users/' + id)
            .then(res => res.json())
            .then(json => {
                this.setState({
                    isLoaded: true,
    ...
    handleFileSubmit(e) {
        ...
        axios.post('https://sunset-space-server.herokuapp.com/api/avatar/' + id, formData)
            .then((response) => {
    ...
    handleUpdateSubmit = (event) => {
        ...
        let user = jwt_decode(localStorage.getItem('jwtToken'));
        let id = user._id;
        axios.put('https://sunset-space-server.herokuapp.com/api/users/' + id, userData)
        .then(res => {
            this.setState({
                items: userData,
